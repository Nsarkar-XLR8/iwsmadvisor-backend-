...
export const createCaseStudy = async (req, res) => {
  try {
    ...
    const description = pickField(req.body, [
      'description',
      'Description',
      'description ',
      'Description ',
    ]);
    const subtitle = pickField(req.body, [
      'subtitle',
      'subTitle',
      'Subtitle',
    ]);
    ...
    const teamSize = pickField(req.body, [
      'teamSize',
      'team_size',
      'TeamSize',
      'Team Size',
    ]);
    const technologiesUsed = pickField(req.body, [
      'technologiesUsed',
      'technologies',
      'TechnologiesUsed',
      'Technologies',
    ]);
    const resultImpact = pickField(req.body, [
      'resultImpact',
      'result',
      'ResultImpact',
      'Result',
    ]);
    const caseExperience = pickField(req.body, [
      'caseExperience',
      'experience',
      'CaseExperience',
      'Experience',
    ]);
    const clientName = pickField(req.body, [
      'clientName',
      'client_name',
      'ClientName',
    ]);
    const companyName = pickField(req.body, [
      'companyName',
      'company_name',
      'CompanyName',
    ]);
...
export const getCaseStudies = async (req, res) => {
  try {
    ...
    const result = await getCaseStudiesService({
      page,
      limit,
      search,
    });
