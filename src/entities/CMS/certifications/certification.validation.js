...
const createCertificationSchema = Joi.object({
    ...
    description1: Joi.string().trim().required().messages({
        "any.required": "Description 1 is required",
        "string.empty": "Description 1 cannot be empty",
    }),
    description2: Joi.string().trim().required().messages({
        "any.required": "Description 2 is required",
        "string.empty": "Description 2 cannot be empty",
    }),
    description3: Joi.string().trim().required().messages({
        "any.required": "Description 3 is required",
        "string.empty": "Description 3 cannot be empty",
    }),
});
